<div class="col-sm-11 col-md-10">
    ...
    <div class="card-header text-white bg-warning" >
        Devoluciones de las ventas Boleteria
    </div>
    <div class="card-body">     
    <div class="row">
    </div>
    <br>   
        ...
        $query=$this->db->query("SELECT idDevolucion,fechaReg,nombreUser as responsable,
            ...
            fechaVenta,v.idVenta,tipoVenta,monto,motivo FROM devolucion d,venta v, usuario u 
            WHERE d.idVenta=v.idVenta
            and d.idUsuario = u.idUsuario and tipo='BOLETERIA'");
        ...
        <tr>
            ...
            <td><?php echo $row->idVenta.' - '.$row->monto.' Bs'; ?></td>
